...
public class RegexEx02 {
	...
	public static void main(String[] args) {
		...
		String info2 = "이순신/주소/010-1234-1234/bbb123@gamil.com";
		...
		// 이메일 형식 (숫자문자@문자.문자)
		String pattern2 = "[a-zA-Z0-9]+@[a-z]+.[a-z]+"; // 여기서 +는 한개이상이라는 뜻
...
//		Matcher y= x.matcher(a);
		...
		for(String a : list){
			...
			Matcher x = Pattern.compile(pattern1).matcher(a);
			Matcher y = Pattern.compile(pattern2).matcher(a);
			if(x.find() && y.find()) {
