		...
		x:		while(true) {
			...
			case "2" : 
				...
				if(index<0) {
					...
					System.out.println("이름 : " + nameList[index] + "생년월일 : " + ageList[index] + " 성별 : "+infoList[index]);
				}
			...
			case "3" : 
				...
				if(index >= count) {
					...
					System.out.printf("이름 : " + nameList[index] + "생년월일 : " + ageList[index] + " 성별 : "+infoList[index]);
				}
